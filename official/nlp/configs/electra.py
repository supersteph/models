...
class ElectraPretrainerConfig(base_config.Config):
  ...
  generator_encoder: encoders.TransformerEncoderConfig = encoders.TransformerEncoderConfig()
  discriminator_encoder: encoders.TransformerEncoderConfig = encoders.TransformerEncoderConfig()
